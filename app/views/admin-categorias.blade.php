                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form role="form" name="contato_observacao"  action="/admin/categoria/novo" method="post">
                                    <label>Nome :</label>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-info" data-toggle="modal" data-target="#contato{{$categoria->id}}" >Editar</button>
                            <!-- Modal -->
                            <div class="modal fade" id="contato{{$categoria->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                  ...
                                  <div class="modal-body">
                                    <div >
                                    <form role="form" name="contato_edicao"  action="/admin/categoria/editar" method="post">
                                    <label>Nome :</label><br>
                                    <input type="text" name="nome"  value="{{$categoria->nome}}" class="form-control" style="width: 100%;"><br>
                            ...
                            &nbsp <button class="btn btn-danger" data-toggle="modal" data-target="#contatoexcluir{{$categoria->id}}" >Excluir</button></td>
                            <div class="modal fade" id="contatoexcluir{{$categoria->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                  ...
                                  <div class="modal-body">
                                    <form role="form" name="categoria_excluir"  action="/admin/categoria/excluir" method="post">
                                    <input type="hidden" name="id" value="{{$categoria->id}}" >
